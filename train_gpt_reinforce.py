...
def main():
    ...
    model = AutoModelForCausalLMWithValueHead.from_pretrained("model_ckpts2")#("gpt2")#, config=config)
    ...
    for epoch in range(num_epochs):
        for batch in train_loader:
            ...
            query_tensors, return_prompt=False,gene_type="default", pad_token_id=tokenizer.eos_token_id, length_sampler=output_length_sampler, **generation_kwargs)
